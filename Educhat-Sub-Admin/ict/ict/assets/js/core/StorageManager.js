class StorageManager {
    ...
    // FAQs Management
    getFAQs() {
        const faqs = this.getItem('ict_faqs') || [];
    ...
    setFAQs(faqs) {
        ...
        return this.setItem('ict_faqs', faqs);
    }
    ...
    getAnnouncements() {
        return this.getItem('ict_announcements') || [];
    }

    setAnnouncements(announcements) {
        return this.setItem('ict_announcements', announcements);
    }
    ...
    getConversations() {
        return this.getItem('ict_conversations') || [];
    }

    setConversations(conversations) {
        return this.setItem('ict_conversations', conversations);
    }

    // Feedback Management (Read-only)
    getFeedback() {
        return this.getItem('ict_feedback') || [];
    }

    setFeedback(feedback) {
        return this.setItem('ict_feedback', feedback);
    }

    // Usage Stats Management
    getUsageStats() {
        return this.getItem('ict_usage_stats') || [];
    }

    setUsageStats(stats) {
        return this.setItem('ict_usage_stats', stats);
    }
    ...
    // Users Management
    getUsers() {
        return this.getItem('ict_users') || [];
    }

    setUsers(users) {
        return this.setItem('ict_users', users);
    }
        ...
        return [
            {
                ...
                answer: 'Official transcripts can be requested through the student portal or by visiting the ICT services office in person. You can also request them online through our secure system.',
                status: 'published',
            ...
            },
            {
                ...
                answer: 'Visit the ICT services office and fill out a Change of Major form. You will need approval from your current department and the new department.',
                status: 'published',
                createdAt: '2023-06-01T10:00:00.000Z',
                updatedAt: '2023-06-01T10:00:00.000Z'
            }
