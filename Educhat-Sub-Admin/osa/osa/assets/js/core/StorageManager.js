class StorageManager {
    ...
    // FAQs Management
    getFAQs() {
        const faqs = this.getItem('studentaffairs_faqs') || [];
    ...
    setFAQs(faqs) {
        ...
        return this.setItem('studentaffairs_faqs', faqs);
    }
    ...
    getAnnouncements() {
        return this.getItem('studentaffairs_announcements') || [];
    }

    setAnnouncements(announcements) {
        return this.setItem('studentaffairs_announcements', announcements);
    }
    ...
    getConversations() {
        return this.getItem('studentaffairs_conversations') || [];
    }

    setConversations(conversations) {
        return this.setItem('studentaffairs_conversations', conversations);
    }

    // Feedback Management (Read-only)
    getFeedback() {
        return this.getItem('studentaffairs_feedback') || [];
    }

    setFeedback(feedback) {
        return this.setItem('studentaffairs_feedback', feedback);
    }

    // Usage Stats Management
    getUsageStats() {
        return this.getItem('studentaffairs_usage_stats') || [];
    }

    setUsageStats(stats) {
        return this.setItem('studentaffairs_usage_stats', stats);
    }
    ...
    // Users Management
    getUsers() {
        return this.getItem('studentaffairs_users') || [];
    }

    setUsers(users) {
        return this.setItem('studentaffairs_users', users);
    }
        ...
        return [
            {
                ...
                answer: 'Official transcripts can be requested through the student portal or by visiting the Office of Student Affairs in person. You can also request them online through our secure system.',
                status: 'published',
            ...
            },
            {
                ...
                answer: 'Visit the Office of Student Affairs and fill out a Change of Major form. You will need approval from your current department and the new department.',
                status: 'published',
                createdAt: '2023-06-01T10:00:00.000Z',
                updatedAt: '2023-06-01T10:00:00.000Z'
            }
