class StorageManager {
    ...
    // FAQs Management
    getFAQs() {
        const faqs = this.getItem('guidance_faqs') || [];
    ...
    setFAQs(faqs) {
        ...
        return this.setItem('guidance_faqs', faqs);
    }
    ...
    getAnnouncements() {
        return this.getItem('guidance_announcements') || [];
    }

    setAnnouncements(announcements) {
        return this.setItem('guidance_announcements', announcements);
    }
    ...
    getConversations() {
        return this.getItem('guidance_conversations') || [];
    }

    setConversations(conversations) {
        return this.setItem('guidance_conversations', conversations);
    }

    // Feedback Management (Read-only)
    getFeedback() {
        return this.getItem('guidance_feedback') || [];
    }

    setFeedback(feedback) {
        return this.setItem('guidance_feedback', feedback);
    }

    // Usage Stats Management
    getUsageStats() {
        return this.getItem('guidance_usage_stats') || [];
    }

    setUsageStats(stats) {
        return this.setItem('guidance_usage_stats', stats);
    }
    ...
    // Users Management
    getUsers() {
        return this.getItem('guidance_users') || [];
    }

    setUsers(users) {
        return this.setItem('guidance_users', users);
    }
        ...
        return [
            {
                ...
                answer: 'Official transcripts can be requested through the student portal or by visiting the guidance office in person. You can also request them online through our secure system.',
                status: 'published',
            ...
            },
            {
                ...
                answer: 'Visit the guidance office and fill out a Change of Major form. You will need approval from your current department and the new department.',
                status: 'published',
                createdAt: '2023-06-01T10:00:00.000Z',
                updatedAt: '2023-06-01T10:00:00.000Z'
            }
