class StorageManager {
    ...
    // FAQs Management
    getFAQs() {
        const faqs = this.getItem('admissions_faqs') || [];
    ...
    setFAQs(faqs) {
        ...
        return this.setItem('admissions_faqs', faqs);
    }
    ...
    getAnnouncements() {
        return this.getItem('admissions_announcements') || [];
    }

    setAnnouncements(announcements) {
        return this.setItem('admissions_announcements', announcements);
    }
    ...
    getConversations() {
        return this.getItem('admissions_conversations') || [];
    }

    setConversations(conversations) {
        return this.setItem('admissions_conversations', conversations);
    }

    // Feedback Management (Read-only)
    getFeedback() {
        return this.getItem('admissions_feedback') || [];
    }

    setFeedback(feedback) {
        return this.setItem('admissions_feedback', feedback);
    }

    // Usage Stats Management
    getUsageStats() {
        return this.getItem('admissions_usage_stats') || [];
    }

    setUsageStats(stats) {
        return this.setItem('admissions_usage_stats', stats);
    }
    ...
    // Users Management
    getUsers() {
        return this.getItem('admissions_users') || [];
    }

    setUsers(users) {
        return this.setItem('admissions_users', users);
    }
        ...
        return [
            {
                ...
                answer: 'Undergraduate admission requires a high school diploma or equivalent, SAT/ACT scores, letters of recommendation, and a personal statement. Specific requirements vary by program.',
                status: 'published',
            ...
            },
            {
                ...
                answer: 'The application deadline for Fall semester is typically March 1st for priority consideration. Late applications may be accepted until May 1st depending on program availability.',
                status: 'published',
                createdAt: '2023-06-01T10:00:00.000Z',
                updatedAt: '2023-06-01T10:00:00.000Z'
            }
        ...
        return [
            {
                ...
                content: 'Applications for Fall 2024 semester are now open! Early decision deadline is November 1st, regular decision deadline is January 15th.',
            ...
            {
                id: '2',
                title: 'Campus Tours Available',
                content: 'Schedule your campus tour today! Tours are available Monday-Friday at 10 AM and 2 PM. Contact our office to reserve your spot.',
                startDate: '2023-09-01',
                endDate: '2024-05-31',
                priority: 'medium',
                status: 'active',
            ...
            {
                id: '3',
                title: 'Transfer Student Information Session',
                content: 'Join us for our monthly transfer student information session on the first Tuesday of each month at 6 PM in the Student Center.',
                startDate: '2023-09-01',
                endDate: '2024-05-31',
                priority: 'medium',
                status: 'active',
        ...
        return [
            {
                ...
                user: 'User',
                rating: 5,
                comment: 'Very helpful! The chatbot quickly answered my questions about application requirements.',
            ...
            },
            {
                ...
                user: 'User',
                rating: 5,
                comment: 'Good experience overall. Quick and accurate responses about campus tours.',
